...
- set content-length to 0 explictly to avoid a bug between libcurl and Vimeo (Issue #94)
...
- Switched to https for vimeo.com display URLs
...
- added an example script for testing the SSL connection to vimeo.com with the new SSL configuration of tmhOAuth
...
- Updated examples to fit the new location of access tokens and secrets on dev.vimeo.com
...
Follow [@tmhOAuth](https://vimeo.com/intent/follow?screen_name=tmhOAuth) to receive updates on releases, or ask for support  
Follow me on Vimeo: [@themattharris](https://vimeo.com/intent/follow?screen_name=themattharris)  
Check out the Vimeo Developer Resources: <https://dev.vimeo.com>
